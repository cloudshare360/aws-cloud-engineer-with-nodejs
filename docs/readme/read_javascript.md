# read_javascript — Section 3: Core Programming Foundation: JavaScript

**Where you are:** [readme hub](../../readme.md) → Section 3 of 12 → previous: [read_setup_environment](read_setup_environment.md) → next: [read_backend_nodejs](read_backend_nodejs.md)
...
| # | Section | Srno | What you master | Hours |
|---|---|---|---|---|
| 1 | JS Introduction | 1–7 | setup, variables, types, operators, comments | 11.5 |
| 2 | JS Control Flow | 8–14 | conditionals, loops, break/continue, switch | 10.0 |
| 3 | JS Functions | 15–18 | functions, hoisting, recursion, scope | 6.0 |
| 4 | JS Objects | 19–23 | objects, methods, constructors, prototypes | 7.5 |
| 5 | JS Types | 24–29 | arrays, strings, numbers, symbols, iteration | 9.0 |
| 6 | Exceptions and Modules | 30–32 | modules, throw, try/catch/finally | 4.5 |
| 7 | JS ES6 | 33–44 | destructuring, classes, Map/Set, spread, templates | 15.5 |
| 8 | JavaScript Asynchronous | 45–49 | callbacks, promises, timers, async/await | 6.5 |
| 9 | Miscellaneous | 50–59 | closures, regex, JSON, generators, `this` | 13.5 |
| | **Total** | **1–59** | | **83.0** |

## Video courses (single home — do not repeat elsewhere)

| Purpose | Video |
|---|---|
| Core JS video course | [Namaste JavaScript 🙏 — Akshay Saini](https://www.youtube.com/watch?v=pN6jk0uUrD8&list=PLlasXeu85E9cQ32gLCvAvr9vNaUccPVNP) |
| Parallel theory | [JavaScript Tutorial — Mosh (1h)](https://www.youtube.com/watch?v=W6NZfCO5SIk&t=2s) |
| OOP theory | [Object-oriented Programming in JavaScript — Mosh](https://www.youtube.com/watch?v=PFmuCDHHpwk) |
| ES6 overview | [ES6 Tutorial: Modern JavaScript in 1 Hour](https://www.youtube.com/watch?v=NCwa_xi0Uuc) |
