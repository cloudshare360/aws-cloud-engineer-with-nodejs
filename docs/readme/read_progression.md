# read_progression — Section 9: Recommended Learning Progression

**Where you are:** [readme hub](../../readme.md) → Section 9 of 12 → previous: [read_process_practice](read_process_practice.md) → next: [read_daily_practice](read_daily_practice.md)

Follow this global order. The environment + JavaScript steps are fully guided by [todo-task/](../../todo-task/) and [programiz-learning/](../../programiz-learning/); later steps are roadmap material you execute the same way (study → commit → log).
...
| 9 | Build full-stack applications end-to-end | [read_fullstack_integration](read_fullstack_integration.md) |
| 10 | Learn AWS core services and deployment patterns | [read_aws_track](read_aws_track.md) |
| 11 | Deploy applications on AWS | [read_aws_track](read_aws_track.md) |
| 12 | Track progress weekly using Git, GitHub, and Kanban | [read_daily_practice](read_daily_practice.md) routine |
